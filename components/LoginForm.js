                    ...
                    <div class="relative text-gray-700 antialiased text-sm font-semibold">
                        ...
                        <div class="mt-6 sm:mt-0 sm:mb-12">
                            <div class="flex flex-col sm:flex-row items-center">
                                ...
                                <div class="rounded-full bg-black border-white border-4 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
                                </div>
                            </div>
                        </div>
